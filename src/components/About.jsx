...
import pic from "../assets/shantanupic.png"
const About = () => {
  return (
    <div
      name="about"
    ...
    >
      <div style={{display:"flex",alignItems:"center"}} className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb-8">
